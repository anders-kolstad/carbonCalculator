---
title: "Interpolation_Kinn_Lista2"
author: "MarteFandrem"
date: "14 12 2021"
output: pdf_document
---
...
```{r, echo=FALSE} 
library(readxl)
library(rgdal) #unsure if I use this
library(raster)
library(ggplot2)
library(gstat)
...
#Import data
```{r}
GIS_points<-readOGR(dsn="C:/Users/martef/DokumenterIntern/GitHub/PhDGRAN/Data/Kinn", layer="lista2_punkter")
shp<-readOGR(dsn="C:/Users/martef/DokumenterIntern/GitHub/PhDGRAN/Data/Kinn", layer="lista2_avgrensing")

peat_depths_data <- read.csv("C:/Users/martef/DokumenterIntern/GitHub/PhDGRAN/Data/Kinn/data_lista2_torvdybder.csv", sep=";")
...
```
#Inverse Distance Weighting (IDW) for Marøy

```{r}
gs<- gstat(formula=Dybde~1, locations=points_EPSG25833, nmax=5, set=list(idp = 0))
