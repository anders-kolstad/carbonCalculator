...
Set power function and the number of nearest neighbours to consider in the interpolation
```{r}
power <- 3
...
```{r}
arrange2 <- ggarrange(estPlot, estPlotG)
ggsave("plot_best_practice_volume_nn.png", arrange2)
```
